...
class FpMatchingEvaluator:
    ...
    def calculateResults(self):
        ...
        for th in range(101):
            ...
            #display
            print("threshold = ", th, ":",                   "false accept = ", self.falseAccept[th],                   "false reject = ", self.falseReject[th])
            self.outFile.write("threshold = " + str(th) + ":" +                   "false accept = " + str(self.falseAccept[th]) +                   "false reject = " + str(self.falseReject[th]) + "\n")
    ...
    def calculateEER(self): 
        ...
        #cal EER
        if (self.falseReject[t1] + self.falseAccept[t1]) <            (self.falseReject[t2] + self.falseAccept[t2]):
